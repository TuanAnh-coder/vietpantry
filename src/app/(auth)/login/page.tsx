...
// Small eco "sprout" mark for the wordmark — shared with the register page.
        ...
        <div className="flex min-h-screen items-center justify-center overflow-y-auto px-10 py-10 sm:px-14">
            <div className="w-full max-w-sm">
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-[#6B7280]">
                    Chào mừng bạn trở lại! Đăng nhập để tiếp tục mua sắm nông sản sạch.
                </p>
                ...
                <form className="mt-6 space-y-4">
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                autoComplete="email"
                                className="h-12 rounded-2xl border-[#E5E7EB] bg-[#F9FAFA] pl-10 text-sm placeholder:text-[#ADB3AF] focus-visible:border-[#4E7C59] focus-visible:ring-[#4E7C59]/20"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <button
                            type="button"
                            className="text-sm font-medium text-[#4E7C59] hover:underline"
                        >
                            Quên mật khẩu?
                        </button>
                    </div>
